...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'bundles/novifyfront/css/style.css' },
			'desktop':	{ range: '737-', href: 'bundles/novifyfront/css/style-desktop.css', containers: 1200, grid: { gutters: 50 } },
			'1000px':	{ range: '737-1200', href: 'bundles/novifyfront/css/style-1000px.css', containers: 960, grid: { gutters: 25 }, viewport: { width: 1080 } },
			'mobile':	{ range: '-736', href: 'bundles/novifyfront/css/style-mobile.css', containers: '100%', grid: { collapse: true, gutters: 10 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				navPanel: {
